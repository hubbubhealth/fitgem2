...
require 'fitgem2/helpers'
require 'fitgem2/errors'
require 'fitgem2/users'
require 'fitgem2/activities'
require 'fitgem2/sleep'
require 'fitgem2/water'
require 'fitgem2/blood_pressure'
require 'fitgem2/glucose'
require 'fitgem2/heart_rate'
require 'fitgem2/units'
require 'fitgem2/foods'
require 'fitgem2/friends'
require 'fitgem2/body_measurements'
require 'fitgem2/time_range'
require 'fitgem2/devices'
require 'fitgem2/notifications'
require 'fitgem2/alarms'
require 'fitgem2/badges'
require 'fitgem2/locales'
require 'date'
require 'uri'
...
module Fitgem
  class Client
    ...
    # @option opts [String] :client_id The client id(required for
    #   OAuth2)
    # @option opts [String] :client_secret The client secret (required
    #   for OAuth2)
    ...
    def initialize(opts)
      missing = [:client_id, :client_secret] - opts.keys
      if missing.size > 0
    ...
    def authentication_request_token(opts={})
      client.options[:authorize_path] = '/oauth/authenticate'
      request_token(opts)
    end
